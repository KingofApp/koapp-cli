...
function build(debug, projectName, platform, options) {
  ...
  if (platform !== 'ios' && platform !== 'android') return tools.debugLog('Invalid platform. Please choose between "ios" or "android".', debug);
  ...
  jsonfile.readFile(`${commandData.repo}/www/core/structure.json`, function(err, obj) {
    ...
    shell.exec(cordova, function(err) {
      if (err) return tools.debugLog(chalk.red(`\n${projectName} project already exists. Please delete the folder or use another name.\n`), debugMode);

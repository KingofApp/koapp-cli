...
function koappCli() {
  if(command === '--help' || command === '-h' || !command) return help();
  try{
...
function help() {
  ...
  console.info('  - create <module|service|spinner|theme>');
  console.info('  - add <pluginType> <pluginName>');
  console.info('  - remove <module|service> <module id|service name>');

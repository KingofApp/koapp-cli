...
function init(debug, projectName, options, env) {
  debugMode = debug;
  visualizer = (env && env === 'dev') ? 'com.kingofapp.visualizer.dev' : 'com.kingofapp.visualizer';

  if(!projectName) return tools.debugLog(charlk.red('Project name is mandatory.'), debugMode);
